		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#helloworldhogentbehelloworld-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"helloworldhogentbehelloworld-display": {
								"semanticObject": "helloworldhogentbehelloworld",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=helloworld.hogent.be.helloworld",
									"url": sap.ui.require.toUrl("helloworld/hogent/be/helloworld")
								}
							}
						}
					}
